...
# === Main Function: Demonstrates All OOP Pillars ===
def main():
    print("=== Vehicle Actions ===")
    toyota = Car("Toyota")
    toyota.start()
    toyota.refuel(30)
    toyota.trip(200, mileage=15)  # 13.33L consumed
    toyota.stop()
    print()

    yamaha = Bike("Yamaha")
    yamaha.start()
    yamaha.refuel(30)  # Over capacity, should be rejected
    yamaha.stop()
    print()
    ...
    volvo.start()
    volvo.refuel(30)
    volvo.trip(200, mileage=5)  # 40L needed, will show insufficient fuel
    volvo.stop()
    print()

    # Simulate long usage for Toyota
